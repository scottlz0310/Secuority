...
class SecuorityError(Exception):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None, exit_code: int = 1):
...
class ProjectAnalysisError(SecuorityError):
    ...
    def __init__(self, message: str, project_path: Optional[str] = None, **kwargs):
...
class TemplateNotFoundError(TemplateError):
    ...
    def __init__(self, template_name: str, search_paths: Optional[list] = None):
...
class GitHubRateLimitError(GitHubAPIError):
    ...
    def __init__(self, reset_time: Optional[int] = None, **kwargs):
...
class ConfigurationConflictError(ConfigurationError):
    ...
    def __init__(self, message: str, conflicts: Optional[list] = None, **kwargs):
        super().__init__(message, **kwargs)
        if conflicts:
...
class BackupError(FileOperationError):
    ...
    def __init__(self, message: str, original_file: Optional[str] = None, backup_file: Optional[str] = None, **kwargs):
...
class DependencyAnalysisError(ProjectAnalysisError):
    ...
    def __init__(self, message: str, dependency_file: Optional[str] = None, **kwargs):
        super().__init__(message, **kwargs)
        if dependency_file:
