...
class SecuorityError(Exception):
    ...
    def __init__(self, message: str, details: dict[str, Any] | None = None, exit_code: int = 1) -> None:
...
class TemplateError(SecuorityError):
    ...
    def __init__(self, message: str, template_name: str | None = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
        if template_name:
...
class TemplateParsingError(TemplateError):
    ...
    def __init__(self, template_name: str, parsing_error: str) -> None:
...
class GitHubRateLimitError(GitHubAPIError):
    ...
    def __init__(self, reset_time: int | None = None, **kwargs: Any) -> None:
...
class FileOperationError(SecuorityError):
    ...
    def __init__(self, message: str, file_path: str | None = None, operation: str | None = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
        if file_path:
            self.details["file_path"] = file_path
        if operation:
...
class DependencyAnalysisError(ProjectAnalysisError):
    ...
    def __init__(self, message: str, dependency_file: str | None = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
        if dependency_file:
