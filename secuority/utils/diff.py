...
class DiffGenerator:
    ...
    def generate_side_by_side_diff(self, old_content: str, new_content: str, width: int = 80) -> str:
    ...
    def generate_change_summary(self, change: ConfigChange) -> str:
        ...
        if change.old_content is not None:
            ...
            diff = self.generate_unified_diff(change.old_content, change.new_content, change.file_path)
