...
def test_actual_merge():
    ...
    try:
        ...
        # テンプレート処理
        processed_template = applier._process_template_variables(template_content, pyproject_path)
        ...
        # マージ処理
        try:
            merged_content, conflicts = applier._merge_toml_file(existing_content, processed_template, pyproject_path)
